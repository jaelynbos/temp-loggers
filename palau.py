...
Points from Palau
'''
palau_mat = loadmat('/projects/f_mlp195/bos_microclimate/loggers_testing/coral_temps_palau.mat')
...
geomorphology
'''
palau_geo = gpd.read_file('/projects/f_mlp195/bos_microclimate/geomorphology/Western-Micronesia.gpkg')
...
palau_mmms.columns = ['level_0','index','q95','q98','MONTH','ID','DAILY_DIFF','TEMP_C','LONGITUDE','LATITUDE','RCLASS','COORDS']
palau_mmms = palau_mmms.drop(columns=['level_0','index'])

palau = prep_data_more(palau,palau_mmms)

outfile = open('/home/jtb188/palau.csv','wb')
